...
st.write("""
# App preço de Ações
O grafico abaixo representa a evolução do preço das cotaçoes ao longo dos anos
         """)# markdown
...
#filtro de acoes
lista_acoes = st.sidebar.multiselect('Escolha ações',dados.columns)
